...
class Post(models.Model):
    ...
    age_limit = models.CharField(max_length=7, choices=AGE_LIMIT.choices, db_index=True)
    status = models.CharField(max_length=20, choices=STATUSES.choices, db_index=True)
    type = models.CharField(max_length=20, choices=TYPES.choices, db_index=True)
